...
class AppModel(models.Model):
    ...
    """
    public_model = False
    """: If True, any authenticated user will be able to create isntances
    of this model
    TODO : is it useful ?"""
    ...
    def reverse(self, suffix, **kwargs):
        """Get a model-instance relative URL, such as a detail, delete
    ...
    def reverse_detail(self, **kwargs):
        ...
        return reverse(
            self.url_namespace(**kwargs) + "detail",
            kwargs={"pk": self.pk}
        )
    ...
    def reverse_update(self, **kwargs):
        ...
        return reverse(
            self.url_namespace(**kwargs) + "update",
            kwargs={"pk": self.pk}
        )
    ...
    def reverse_delete(self, **kwargs):
        ...
        return reverse(
            self.url_namespace(**kwargs) + "delete",
            kwargs={"pk": self.pk}
        )
